...
void G1ConcurrentMark::update_concurrent_mark_threads_cpu_time() {
  ...
  CollectorCPUTimeCounters* counters = _g1h->cpu_time_counters();
  ThreadTotalCPUTimeClosure tttc(counters->get_counter(CollectorCPUTimeGroups::gc_conc_mark), counters);
